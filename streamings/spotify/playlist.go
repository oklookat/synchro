...
func newPlaylist(account streaming.Account, playlist spotify.SimplePlaylist, client *spotify.Client) *Playlist {
	return &Playlist{
...
func (e *Playlist) addRemoveTracks(ctx context.Context, ids []streaming.ServiceEntityID, add bool) error {
	e.cachedTracks = nil
