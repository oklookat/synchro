...
func newAccountActions(account streaming.Account) (*AccountActions, error) {
...
type AccountActions struct {
	account streaming.Account
	client  *gozvuk.Client
}

func (e AccountActions) LikedAlbums() streaming.LikedActions {
	return &LikedAlbumsActions{client: e.client}
}

func (e AccountActions) LikedArtists() streaming.LikedActions {
	return &LikedArtistsActions{client: e.client}
}

func (e AccountActions) LikedTracks() streaming.LikedActions {
	return &LikedTracksActions{client: e.client}
}

func (e AccountActions) Playlist() streaming.PlaylistActions {
...
func (e LikedAlbumsActions) Liked(ctx context.Context) ([]streaming.ServiceEntity, error) {
	...
	result := []streaming.ServiceEntity{}
...
func (e LikedAlbumsActions) Like(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, true)
}

func (e LikedAlbumsActions) Unlike(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, false)
}

func (e LikedAlbumsActions) likeUnlike(ctx context.Context, ids []streaming.ServiceEntityID, like bool) error {
...
func (e LikedArtistsActions) Liked(ctx context.Context) ([]streaming.ServiceEntity, error) {
...
func (e LikedArtistsActions) Like(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, true)
}

func (e LikedArtistsActions) Unlike(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, false)
}

func (e LikedArtistsActions) likeUnlike(ctx context.Context, ids []streaming.ServiceEntityID, like bool) error {
...
func (e LikedTracksActions) Liked(ctx context.Context) ([]streaming.ServiceEntity, error) {
...
func (e LikedTracksActions) Like(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, true)
}

func (e LikedTracksActions) Unlike(ctx context.Context, ids []streaming.ServiceEntityID) error {
	return e.likeUnlike(ctx, ids, false)
}

func (e LikedTracksActions) likeUnlike(ctx context.Context, ids []streaming.ServiceEntityID, like bool) error {
	return likeUnlike(ctx, e.client, ids, schema.CollectionItemTypeTrack, like)
}

func likeUnlike(ctx context.Context, cl *gozvuk.Client, ids []streaming.ServiceEntityID, itype schema.CollectionItemType, like bool) error {
...
func (e *PlaylistActions) MyPlaylists(ctx context.Context) ([]streaming.ServicePlaylist, error) {
	resp, err := e.client.UserPlaylists(ctx)
	if err != nil {
		return nil, err
	}

	if len(e.profileID) == 0 {
	...
	for _, item := range resp.Data.Collection.Playlists {
		...
		if len(item.UserID.String()) == 0 || len(item.ID.String()) == 0 {
			continue
		}
		if item.UserID.String() != e.profileID {
			continue
		}
		myPlaylistsIds = append(myPlaylistsIds, *item.ID)
	}

	result := []streaming.ServicePlaylist{}
...
func (e PlaylistActions) Create(ctx context.Context, name string, isVisible bool, description *string) (streaming.ServicePlaylist, error) {
...
func (e PlaylistActions) Delete(ctx context.Context, ids []streaming.ServiceEntityID) error {
	for _, id := range ids {
		if len(id) == 0 {
			continue
		}
...
func (e PlaylistActions) MyPlaylist(ctx context.Context, id streaming.ServiceEntityID) (streaming.ServicePlaylist, error) {
